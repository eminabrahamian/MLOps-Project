...
from src.features.feature_eng import create_features
from src.preprocess.preprocessing import get_preprocessing_pipeline
...
def run_pipeline(config, stage, input_csv=None, output_csv=None):
    ...
    if stage in ['all', 'train']:
        ...
        pipeline = get_preprocessing_pipeline(config['preprocessing'])
    ...
    if stage == 'infer':
        ...
        run_inference(config, input_csv, output_csv)
